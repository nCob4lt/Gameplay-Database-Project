...
class QueryCog(commands.Cog):
    ...
    async def get_music_by_name(self, interaction: discord.Interaction, name: str):
        ...
        embed.add_field(name="Type", value=music["type"] if music['type'] else "None", inline=False)
        ...
        embed.add_field(name="Newgrounds ID", value=music["ngid"] if music['ngid'] else "None", inline=False)
